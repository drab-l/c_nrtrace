...
static void sb_print_sockaddr(string_buffer *sb, void *p, size_t size)
{
...
static void sb_print_ptr2sockaddr(string_buffer *sb, void *p, size_t size, const syscall_info_t *)
{
    sb_print_sockaddr(sb, p, size);
}
